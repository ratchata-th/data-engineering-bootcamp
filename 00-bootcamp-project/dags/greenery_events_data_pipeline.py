...
def _load_data_from_gcs_to_bigquery(ds, ds_nodash):
    keyfile_bigquery = f"{DAGS_FOLDER}/deb2-loading-data-to-gcs-then-bigquery-deb2-395909-5c0b85866983.json"
    ...
    table_id = f"{PROJECT_ID}.my_deb_project_bootscamp.{DATA}${ds_nodash}"
